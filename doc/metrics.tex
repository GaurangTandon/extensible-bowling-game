...
\begin{itemize}
    ...
    \item These parts were then systematically split out into separate classes, namely, \code{Bowlers.ScorableParty, Lane.LaneWithPinsetter, Observer.Publisher, Lane.Lane}
