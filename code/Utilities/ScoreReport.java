...
public class ScoreReport {
    ...
    public ScoreReport(final BowlerInfo bowler, final int[] scores, final int games) {
        ...
        assert v != null;
        content = "--Lucky Strike Bowling Alley Utilities.Score Report--\n\n"
    ...
    private void sendEmail(final String recipient) {
        try {
            ...
            linesToSend = "Subject: Bowling Utilities.Score Report\nFrom: <Lucky Strikes Bowling Club>\nContent-Type: text/plain; charset=\"us-ascii\"\r\n" + content + "\n\n\n\r\n";
