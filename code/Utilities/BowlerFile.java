...
public final class BowlerFile {
    ...
    /**
     * Retrieves bowler information from the database and returns a Bowlers.Bowler objects with populated fields.
     *
     * @param nickName the nickName of the bowler to retrieve
     * @return a Bowlers.Bowler object
     */

    public static BowlerInfo getBowlerInfo(final String nickName)
            throws IOException {
     ...
     */
    public static ArrayList<String> putBowlerIfDidntExist(final String nick, final String full, final String email) {
        try {
    ...
    /**
     * Stores a Bowlers.Bowler in the database
     *
     * @param nickName the NickName of the Bowlers.Bowler
     * @param fullName the FullName of the Bowlers.Bowler
     * @param email    the E-mail Address of the Bowlers.Bowler
     */
