...
import Utilities.ScoreHistoryFile;
import Widget.*;
...
class AdhocView extends WindowView implements ActionListener, ListSelectionListener {
    ...
    private void displayLowest() {
        ...
        final String str = "<html>Lowest Utilities.Score achieved by bowler:<br/>" + currScore.getNick()
    ...
    private void displayHighest() {
        ...
        final String str = "<html>Highest Utilities.Score achieved by bowler:<br/>" + currScore.getNick()
                + "<br/>with score " + currScore.getScore() + "</html>";
        statDisplay.setText(str);
    }
